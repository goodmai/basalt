...
public actor OnboardingFlow {
    ...
    public init(configPath: String = "~/.gemmaserver/onboarding.json") {
    ...
    public func run() async throws {
        ...
        case "1":
            ...
            print("  2. Start server:   GemmaServer serve --model \(recommendation.modelId)")
            print("")
        ...
        case "2":
            ...
            print("  2. Start server:   GemmaServer serve --model \(customModel)")
            print("")
            
        case "3":
            print("")
            print("⏭️  Skipping setup. You can run onboarding again with:")
            print("   GemmaServer onboard")
            print("")
            selectedModel = nil
        ...
        print("  • List models:     GemmaServer list-models")
        print("  • Start server:    GemmaServer serve --model <model-id>")
        print("  • Run benchmark:   GemmaServer benchmark --model <model-id>")
        print("  • Get help:        GemmaServer --help")
        print("")
